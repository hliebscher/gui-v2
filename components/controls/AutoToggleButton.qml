...
BaseAutoToggleSwitch {
	...
	property int buttonWidth: (root.width - (Theme.geometry_button_border_width * (root.buttonCount + 1)) - Theme.geometry_autotoggle_button_spacing) / root.buttonCount
